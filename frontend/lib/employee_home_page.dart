...
class _EmployeeHomePageState extends State<EmployeeHomePage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _fetchBusinesses() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://192.168.0.102:5000/api/business/employees/buisness'),
        headers: {
  ...
  Future<void> _fetchPendingRequests() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://192.168.0.102:5000/api/auth/pending'),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
  ...
  Future<void> _acceptRequest(String businessId) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://192.168.0.102:5000/api/business/accept'),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
  ...
  Future<void> _rejectRequest(String businessId) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://192.168.0.102:5000/api/business/reject'),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
